...
const command: ICommand = {
  ...
  async execute(message: Message, _con: Client, args?: string[]) {
    console.log(
      `Command changetextpermissions started by user ${
    ...
    for (const permissionChange of args) {
      ...
      if (operation !== "r") {
        ...
        console.log(
          "Attempting to find permission number in text channel permissions."
        );
        ...
        if (isNaN(permissionNum)) {
          ...
          if (
            !textChannelPermissions.includes(
        ...
        switch (
          ...
          case "+":
            try {
              ...
              await (textChannel as TextChannel).permissionOverwrites.create(
                role,
                textChannelPermissionsEnable.get(
          ...
          case "-":
            try {
              ...
              await (textChannel as TextChannel).permissionOverwrites.create(
                role,
                textChannelPermissionDisable.get(
                  permission as PermissionResolvable
                )
    ...
    try {
      ...
      console.log(
        `Command changetextpermissions, started by ${
          message.member!.user.tag
