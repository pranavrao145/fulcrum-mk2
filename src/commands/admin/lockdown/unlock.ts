...
const command: ICommand = {
    ...
    async execute(message: Message, _con: Client, _args?: string[]) {
        ...
        try {
            (messageChannel as TextChannel).updateOverwrite((messageChannel as TextChannel).guild.roles.everyone, {SEND_MESSAGES: true}); // set the channel as read only for everyone
