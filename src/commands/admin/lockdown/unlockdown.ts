...
const command: ICommand = {
    name: 'unlockdown',
    description: 'Releases server from lockdown triggered by f!lockdown. **WARNING:** This **deletes** permission overwrites on the @everyone role for all channels (resets it to default permissions), so make sure any other roles required to restrict permissions are assigned and set with the correct permissions.',
    syntax: 'f!unlockdown',
