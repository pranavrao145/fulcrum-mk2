...
const command: ICommand = {
    name: 'assignuser',
    description: 'Assigns all the given roles to the given user. You can give upto 10 roles to a user with one command.',
    alias: ['au'],
    ...
    async execute(message: Message, _con: Client, args?: string[]) {
        ...
        try { // send output embed with information about the command's success
            ...
            console.log(`Command assignuser, started by ${message.member!.user.tag}, terminated successfully in ${message.guild!.name}.`);
        } catch (e) {
