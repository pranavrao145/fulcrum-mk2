...
const command: ICommand = {
  ...
  async execute(message: Message, _con: Client, args?: string[]) {
    console.log(
      `Command createroles started by user ${
    ...
    for (let roleName of args!) {
      // iterate through each of the role names given
      ...
      if (
        ...
        console.log(
          `Role with name ${roleName} already exists in guild. Skipping over it.`
        );
    ...
    try {
      ...
      console.log(
        `Command createroles, started by ${
          message.member!.user.tag
