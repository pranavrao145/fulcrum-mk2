...
const command: ICommand = {
    ...
    async execute(message: Message, con: Client, args?: string[]) {
        console.log(`Command update started by user ${message.member!.user.tag} in guild ${message.guild!.name}.`);
        ...
        switch (service) { // check for different services to update
            case 'channelcount':
                ...
                if (!serviceCommand) { // if the command does not exist
                    console.log('Service command updatechannelcount not found. Stopping execution.');
                    try {
            ...
            case 'date':
                ...
                if (!serviceCommand) { // if the command does not exist
                    console.log('Service command updatedate not found. Stopping execution.');
                    try {
                        return await message.channel.send('An internal error occured. Please try again later.');
                    } catch (e) {
                        console.log(`There was an error sending a message in the guild ${message.guild!.name}! The error message is below:`);
            ...
            case 'membercount':
                ...
                if (!serviceCommand) { // if the command does not exist
                    console.log('Service command updatemembercount not found. Stopping execution.');
                    try {
                        return await message.channel.send('An internal error occured. Please try again later.');
                    } catch (e) {
                        console.log(`There was an error sending a message in the guild ${message.guild!.name}! The error message is below:`);
            ...
            case 'vcroles':
                ...
                if (!serviceCommand) { // if the command does not exist
                    console.log('Service command updatevcroles not found. Stopping execution.');
                    try {
                        return await message.channel.send('An internal error occured. Please try again later.');
                    } catch (e) {
                        console.log(`There was an error sending a message in the guild ${message.guild!.name}! The error message is below:`);
